...
export const dummyProducts = [
  ...
  },
  {
    ...
    images: [product_3],
    price: { H: 6, F: 11 },
    description: "Smoky BBQ sauce with grilled meat",
    category: "Burger",
    type: "BBQ Burger",
    sizes: ["H", "F"],
    date: 1716634345451,
  ...
  },
  {
    ...
    images: [product_5],
    price: { H: 7, F: 12 },
    description: "Extra cheese and double patties",
    category: "Burger",
    type: "Double Cheese Burger",
    sizes: ["H", "F"],
    date: 1716634345453,
    popular: true,
    inStock:true,
  ...
  },
  {
    ...
    images: [product_7],
    price: { H: 4, F: 6 },
    description: "Creamy chocolate blended shake",
    category: "Drink",
    type: "Chocolate Milkshake",
    sizes: ["H", "F"],
    date: 1716634345455,
    popular: true,
    inStock:true,
