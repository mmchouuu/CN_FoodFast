...
router.get('/:restaurantId/reviews', controller.listRestaurantReviews);
router.post('/:restaurantId/reviews', controller.createRestaurantReview);
router.get('/:restaurantId/products/:productId/reviews', controller.listProductReviews);
